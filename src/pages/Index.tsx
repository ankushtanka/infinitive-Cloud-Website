...
import PremiumVisualSection from "@/components/PremiumVisualSection";
...
const Index = () => {
  ...
  const faqSchema = createFAQSchema([
    ...
    { question: "Do you offer a free trial?", answer: "Yes! We offer a 14-day free trial on all cloud and VPS hosting plans with no credit card required." },

...
const StreamingServers = () => {
  const { c } = usePageContent("streaming-servers");
  const features = [
  ...
  return (
    <>
      <Helmet>
        <title>{c("meta_title", "Streaming Servers | Live & VOD Hosting - Infinitive Cloud")}</title>
        <meta name="description" content={c("meta_description", "High-performance streaming servers for live broadcasts and on-demand video. Ultra-low latency, global CDN, unlimited bandwidth, and DRM protection.")} />
        ...
        <meta property="og:title" content={c("og_title", "Streaming Servers | Live & VOD Hosting")} />
        <meta property="og:description" content={c("og_description", "Streaming servers with ultra-low latency, global CDN, unlimited bandwidth, and DRM.")} />
        ...
        <main className="pt-24 pb-20">
          <section className="section-container mb-16">
            <div className="max-w-4xl mx-auto text-center animate-fade-in">
              <h1 className="mb-6">
                {c("hero_heading") || <><span className="gradient-text">Streaming</span> Servers</>}
              </h1>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                {c("hero_subtext", "Unlimited streaming servers built for flawless live broadcasts and on-demand video delivery. No buffering, no limits — just seamless playback for your audience worldwide.")}
              </p>

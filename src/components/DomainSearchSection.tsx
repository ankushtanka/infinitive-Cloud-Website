              ...
              >
                ...
                {tld.tag && (
                  <div className="absolute top-2 right-2 md:top-3 md:right-3">
                    <span className="text-[10px] md:text-xs font-bold bg-primary/90 dark:bg-primary/80 text-primary-foreground px-2.5 md:px-3 py-1 rounded-full uppercase tracking-wider shadow-md">
                      {tld.tag}
                    </span>
                  </div>
                )}

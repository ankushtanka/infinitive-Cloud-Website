...
const DomainSearchSection: React.FC = () => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    if (!term) return;
    setNavigating(true);
    navigate(`/domain-search?q=${encodeURIComponent(term)}`);
  };
      ...
      <div className="section-container relative">
        ...
        <div className="max-w-3xl mx-auto mb-10 md:mb-14">
          <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1 group">
              ...
              <div className="relative">
                ...
                <Input
                  type="text"
                  placeholder={
                    domain ? "" : !inputFocused ? `${animatedPlaceholder}|` : "Enter your domain name..."
                  }
                  value={domain}
            ...
            >
              ...
              {navigating ? "Searching..." : "Search Domain"}
            </Button>
          </form>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 md:gap-6 max-w-5xl mx-auto">
          {fallbackTlds.map((tld, i) => (
            <Card
              ...
              style={{ animationDelay: `${i * 0.06}s`, boxShadow: "var(--shadow-soft)" }}
              onMouseEnter={(e) => {
        ...
        <div className="text-center mt-10 md:mt-12">
          <Link to="/solutions/domains">
            <Button size="lg" variant="outline" className="group text-sm md:text-base rounded-xl">

...
import { ArrowRight, Shield, Headphones, Server, Cloud, CheckCircle2 } from "lucide-react";
        ...
        <div className="max-w-5xl w-full flex flex-col items-center text-center">
          ...
          <div className="flex items-center gap-2 mb-5 md:mb-7">
            <div className="flex items-center gap-0.5">
              {[1,2,3,4,5].map((i) => (
                <svg key={i} className={`w-4 h-4 md:w-5 md:h-5 ${i <= 4 ? "fill-yellow-400 text-yellow-400" : "fill-yellow-400/50 text-yellow-400/50"}`} viewBox="0 0 20 20">
            ...
            <span className="text-xs md:text-sm text-muted-foreground">· Trusted by 1,200+ businesses across India</span>
          </div>

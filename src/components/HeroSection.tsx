    ...
    <section className="relative pt-32 pb-20 overflow-hidden min-h-[80vh] flex items-center">
      ...
      <div className="section-container w-full relative z-10">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-4 max-w-2xl mx-auto font-semibold">Limitless solutions for cloud and web hostings

          </p>
          
          <p className="text-base md:text-lg text-foreground/60 mb-10 max-w-xl mx-auto leading-relaxed">Managed VPS, dedicated servers, shared hosting, and enterprise infrastructure — built for speed, security, and scale.
